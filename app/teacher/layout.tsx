          ...
          <div className="p-4 border-t">
            <div className="flex items-center gap-3 mb-3 px-3 py-2">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium truncate">{user?.name || "Giáo viên"}</p>
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <header className="flex-shrink-0 z-30 flex items-center gap-4 border-b bg-background px-4 py-3 lg:hidden">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold bg-gradient-to-r from-blue-500 to-blue-600 bg-clip-text text-transparent">
              EduScore
            </span>
          </div>
        </header>
